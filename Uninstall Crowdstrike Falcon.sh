...
# Create API account on crowdstrike and get client id & secret id and update it in this screept
# Please test this script on local device device before go live.
